...
func (e *ElevState) HasOrders() bool {
...
func (e* ElevState) HasOrdersAbove() bool {
...
func (e* ElevState) HasOrdersBelow() bool {
...
func (e * ElevState) OnObstructionSignal(obstructed bool) {
			fmt.Printf("[OBSTR] %+v\n", obstructed)
			if obstructed {
				e.io.SetMotorDirection(elevio.MD_Stop)
			} else {
